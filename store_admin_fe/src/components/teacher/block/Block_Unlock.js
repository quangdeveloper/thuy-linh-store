...
import {changeStatusTeacher} from "../../../shared/services/teacher.service";

const Block_Unlock = (props) => {
    ...
    const update = () => {
        ...
        const data = {
            id: teacher.id,
            status: teacher.status === 1 ? 2 : 1
        }
        changeStatusTeacher(data).then(res => {
