...
import {createTeacher, getApiUrlUploadTeacher} from "../../../shared/services/teacher.service";
...
const AddTeacher = (props) => {
    ...
    const createNewTeacher = (teacher) => {
        uploadTeacherImage()
            ...
            .then((result) => {
                if (result.code === "00") {
                    ...
                    createTeacher(_teacher).then(res => {
                        if (res.data.code === "00") toast.success("Thêm mới giảng viên thành công")
