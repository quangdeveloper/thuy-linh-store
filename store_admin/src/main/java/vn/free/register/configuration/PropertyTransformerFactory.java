...
import vn.free.register.configuration.transformers.*;
import vn.free.register.configuration.util.ClassUtils;
...
public class PropertyTransformerFactory {
     ...
     * {@link vn.free.register.configuration.TransformationException} if can't
     * create new one.
     *
     * @param clazzToTransform Class that will is going to be transformed
     * @param tc {@link vn.free.register.configuration.PropertyTransformer} class
     * that will be instantiated
     * @return instance of PropertyTransformer
     * @throws TransformationException if can't instantiate
     * {@link vn.free.register.configuration.PropertyTransformer}
     */
