...
public class ConfigurableProcessor {
    ...
    public static Logger getLogger() {
        if (logger == null) {
            logger = LoggerFactory.getLogger(ConfigurableProcessor.class);
        }
        return logger;
    }
     ...
     * (non-static)<br>
     * If class is submitted(Something.class), static fields are parsed.<br>
     *
     * @param object Class or Object that has {@link Property} annotations.
     * @param properties Properties that should be used while searching for a
     * {@link Property#key()}
     */
    ...
    /**
     * This method uses recursive calls to launch search for {@link Property}
    ...
    /**
     * This method runs through the declared fields watching for the
     * {@link Property} annotation. It also watches for the field modifiers like
     * {@link Modifier#STATIC} and
     * {@link Modifier#FINAL}
     *
     * @param clazz Class of object
     * @param obj Object if any, null if parsing class (static fields only)
     ...
     * {@link #getFieldValue(Field, Properties[])}
    ...
    private static void processField(Field f, Object obj, Properties[] props) {
        ...
        } catch (TransformationException | IllegalArgumentException | IllegalAccessException e) {
            throw new RuntimeException();
        }
     ...
     * {@link vn.free.register.configuration.PropertyTransformerFactory}
     *
     ...
     *
     * @param key value key
     * @param props properties to look for the key
     ...
     * @param props properties to look for key
